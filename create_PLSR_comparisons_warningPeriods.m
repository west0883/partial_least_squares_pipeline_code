...
for typei = 1:numel(types)
    ...
    comparisons(counter + typei).variablesToUse = {'speed_vector', 'duration_vector', 'pupil_diameter_vector', 'tail_vector', 'nose_vector', 'FL_vector', 'HL_vector', 'x_vector'};
...
for typei = 1:numel(types)
    comparisons(counter + typei).name = ['continuousVars_' types{typei}];
    comparisons(counter + typei).variablesToUse = {'duration_vector', 'pupil_diameter_vector', 'tail_vector', 'nose_vector', 'FL_vector', 'HL_vector', 'x_vector'};
    comparisons(counter + typei).type = types{typei};
