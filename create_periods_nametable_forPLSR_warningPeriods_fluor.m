% create_periods_nametable_forPLSR_warningPeriods_fluor.m
% Sarah West
% 6/29/22
...
%% Save 
save([parameters.dir_exper 'PLSR fluorescence Warning Periods\periods_nametable_forPLSR_warningPeriods_fluore.mat'], 'periods', '-v7.3');
