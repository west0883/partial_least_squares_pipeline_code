...
% first step).
if isfile([parameters.dir_exper 'PLSR fluorescence Warning Periods\periods_nametable_forPLSR_warningPeriods_fluore.mat'])
    load([parameters.dir_exper 'PLSR fluorescence Warning Periods\periods_nametable_forPLSR_warningPeriods_fluore.mat']);
...
% Output
parameters.loop_list.things_to_save.data_evaluated.dir = {[parameters.dir_exper 'PLSR fluorescence Warning Periods\variable prep\'], 'mouse', '\'};
...
% Data is already shortened/trimmed
...
parameters.loop_list.things_to_load.data.dir = {[parameters.dir_exper 'PLSR fluorescence Warning Periods\variable prep\'], 'mouse', '\'};
...
% Pupil diameter
parameters.loop_list.things_to_load.pupil_diameter_vector.dir = {[parameters.dir_exper 'behavior\eye\diameter for fluorescence PLSR Warning Periods\'], 'mouse', '\'};
...
parameters.loop_list.things_to_load.explanatory.dir = {[parameters.dir_exper 'PLSR fluorescence Warning Periods\variable prep\'], 'mouse', '\'};
...
parameters.loop_list.things_to_load.values_old.dir = {[parameters.dir_exper 'PLSR fluorescence Warning Periods\variable prep\'], 'mouse', '\'};
...
if do 
    ...
    % Betas
    parameters.loop_list.things_to_save.BETAs_randomPermutations.dir = {[parameters.dir_exper 'PLSR fluorescence Warning Periods\results\level 1 continuous\'], 'comparison', '\' 'mouse', '\'};
...
if do 
    ...
    parameters.loop_list.things_to_save.BETAs_randomPermutations.dir = {[parameters.dir_exper 'PLSR fluorescence Warning Periods\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
    parameters.loop_list.things_to_save.BETAs_randomPermutations.filename= {'PLSR_BETAs_randomPermutations.mat'};
    parameters.loop_list.things_to_save.BETAs_randomPermutations.variable= {'BETAs_randomPermutations'}; 
    parameters.loop_list.things_to_save.BETAs_randomPermutations.level = 'comparison';
