...
continuous_variable_names = {'speed_vector', 'accel_vector', 'duration_vector', 'pupil_diameter_vector', 'tail_vector', 'nose_vector'};
...
comparisons(counter).variablesToUse = {'duration_vector', 'pupil_diameter_vector', 'tail_vector', 'nose_vector'};
...
comparisons(counter).variablesToUse = {'speed_vector', 'accel_vector','duration_vector', 'pupil_diameter_vector', 'tail_vector', 'nose_vector'};
comparisons(counter).type = 'finished_stop';
...
comparisons(counter).variablesToUse = {'speed_vector', 'duration_vector', 'pupil_diameter_vector' , 'tail_vector', 'nose_vector'};
