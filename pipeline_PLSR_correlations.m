...
parameters.loop_list.things_to_load.data.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\'], 'comparison', '\' 'mouse', '\'};
...
% Output 
% Concatenated data
parameters.loop_list.things_to_save.concatenated_data.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\ncomponents\'],'mouse', '\'};
...
% Histogram
parameters.loop_list.things_to_save.histogram.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\ncomponents\'], 'mouse', '\'};
...
% Output
parameters.loop_list.things_to_save.fig_weights.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\'], 'comparison', '\' 'mouse', '\'};
...
parameters.loop_list.things_to_save.fig_MSEPs_explanatory.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\plots\'],  'mouse', '\'};
...
parameters.loop_list.things_to_save.fig_MSEPs_response.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\plots\'],  'mouse', '\'};
...
parameters.loop_list.things_to_save.fig_BICs_explanatory.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\plots\'],  'mouse', '\'};
...
parameters.loop_list.things_to_save.fig_BICs_response.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\plots\'],  'mouse', '\'};
...
% parameters.loop_list.things_to_save.fig_PCTVARs_explanatory.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\plots\'],  'mouse', '\'};
...
% 
% parameters.loop_list.things_to_save.fig_PCTVARs_response.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\plots\'],  'mouse', '\'};
...
parameters.loop_list.things_to_save.fig_COVs.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\'], 'comparison', '\' 'mouse', '\'};
...
parameters.loop_list.things_to_save.dataset_out.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\'], 'mouse', '\'};
...
% Output
parameters.loop_list.things_to_save.results.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
parameters.loop_list.things_to_save.results.filename= {'PLSR_results.mat'};
parameters.loop_list.things_to_save.results.variable= {'PLSR_results'}; 
parameters.loop_list.things_to_save.results.level = 'comparison';
...
% Input 
% Number of components used
parameters.loop_list.things_to_load.data.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
parameters.loop_list.things_to_load.data.filename= {'PLSR_results.mat'};
parameters.loop_list.things_to_load.data.variable= {'PLSR_results.ncomponents_used'}; 
parameters.loop_list.things_to_load.data.level = 'comparison';
...
% Output 
% Concatenated data
parameters.loop_list.things_to_save.concatenated_data.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\ncomponents\'],'mouse', '\'};
parameters.loop_list.things_to_save.concatenated_data.filename= {'ncomponents_used_allcomparisons.mat'};
parameters.loop_list.things_to_save.concatenated_data.variable= {'ncomponents_used_allcomparisons'}; 
parameters.loop_list.things_to_save.concatenated_data.level = 'mouse';
% Histogram
parameters.loop_list.things_to_save.histogram.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\ncomponents\'], 'mouse', '\'};
parameters.loop_list.things_to_save.histogram.filename= {'ncomponents_used_allcomparisons.fig'};
parameters.loop_list.things_to_save.histogram.variable= {'ncomponents_used_allcomparisons_fig'}; 
parameters.loop_list.things_to_save.histogram.level = 'mouse';
...
% Input
parameters.loop_list.things_to_load.results.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
parameters.loop_list.things_to_load.results.filename= {'PLSR_results.mat'};
parameters.loop_list.things_to_load.results.variable= {'PLSR_results'}; 
parameters.loop_list.things_to_load.results.level = 'comparison';
...
% Output
parameters.loop_list.things_to_save.fig_weights.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
parameters.loop_list.things_to_save.fig_weights.filename= {'PLSR_weights.fig'};
parameters.loop_list.things_to_save.fig_weights.variable= {'fig_weights'}; 
parameters.loop_list.things_to_save.fig_weights.level = 'comparison';

parameters.loop_list.things_to_save.fig_MSEPs_explanatory.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\plots\'],  'mouse', '\'};
parameters.loop_list.things_to_save.fig_MSEPs_explanatory.filename= {'PLSR_MSEPs_explanatory.fig'};
parameters.loop_list.things_to_save.fig_MSEPs_explanatory.variable= {'fig_MSEPs_explanatory'}; 
parameters.loop_list.things_to_save.fig_MSEPs_explanatory.level = 'mouse';

parameters.loop_list.things_to_save.fig_MSEPs_response.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\plots\'],  'mouse', '\'};
parameters.loop_list.things_to_save.fig_MSEPs_response.filename= {'PLSR_MSEPs_response.fig'};
parameters.loop_list.things_to_save.fig_MSEPs_response.variable= {'fig_MSEPs_response'}; 
parameters.loop_list.things_to_save.fig_MSEPs_response.level = 'mouse';

parameters.loop_list.things_to_save.fig_BICs_explanatory.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\plots\'],  'mouse', '\'};
parameters.loop_list.things_to_save.fig_BICs_explanatory.filename= {'PLSR_BICs_explanatory.fig'};
parameters.loop_list.things_to_save.fig_BICs_explanatory.variable= {'fig_BICs_explanatory'}; 
parameters.loop_list.things_to_save.fig_BICs_explanatory.level = 'mouse';

parameters.loop_list.things_to_save.fig_BICs_response.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\plots\'],  'mouse', '\'};
parameters.loop_list.things_to_save.fig_BICs_response.filename= {'PLSR_BICs_response.fig'};
parameters.loop_list.things_to_save.fig_BICs_response.variable= {'fig_BICs_response'}; 
parameters.loop_list.things_to_save.fig_BICs_response.level = 'mouse';

% parameters.loop_list.things_to_save.fig_PCTVARs_explanatory.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\plots\'],  'mouse', '\'};
% parameters.loop_list.things_to_save.fig_PCTVARs_explanatory.filename= {'PLSR_PCTVARs_explanatory.fig'};
% parameters.loop_list.things_to_save.fig_PCTVARs_explanatory.variable= {'fig_PCTVARs_explanatory'}; 
% parameters.loop_list.things_to_save.fig_PCTVARs_explanatory.level = 'mouse';
% 
% parameters.loop_list.things_to_save.fig_PCTVARs_response.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\plots\'],  'mouse', '\'};
% parameters.loop_list.things_to_save.fig_PCTVARs_response.filename= {'PLSR_PCTVARs_response.fig'};
% parameters.loop_list.things_to_save.fig_PCTVARs_response.variable= {'fig_PCTVARs_response'}; 
% parameters.loop_list.things_to_save.fig_PCTVARs_response.level = 'mouse';

parameters.loop_list.things_to_save.fig_COVs.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
parameters.loop_list.things_to_save.fig_COVs.filename= {'PLSR_Cov.fig'};
parameters.loop_list.things_to_save.fig_COVs.variable= {'fig'}; 
parameters.loop_list.things_to_save.fig_COVs.level = 'comparison';
RunAnalysis({@CheckComponents}, parameters);
...
% Output 
parameters.loop_list.things_to_save.average_sigmas.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 categorical\'], 'comparison','\'};
...
if parameters.removeOutliers
parameters.loop_list.things_to_save.sigma_outliers.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 categorical\'], 'comparison','\'};
...
for i = 1 %:numel(true_false_vector)
    ...
    for j = 1%:numel(true_false_vector)
        ...
        % Input
        parameters.loop_list.things_to_load.average_across_mice.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 categorical\'], 'comparison', '\'};
        ...
        % significance matrix
        if parameters.useSignificance
        parameters.loop_list.things_to_load.significance.dir = {[parameters.dir_exper 'PLSR\results\level 2 categorical\'], 'comparison', '\'};
        ...
        % Average sigmas.
        if parameters.adjustBetas
        parameters.loop_list.things_to_load.average_sigmas.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 categorical\'], 'comparison', '\'};
        ...
        parameters.loop_list.things_to_save.fig.dir = {[parameters.dir_exper 'PLSR\results\level 2 categorical\']};
...
% Output 
parameters.loop_list.things_to_save.average_sigmas.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 continuous\'], 'comparison','\'};
parameters.loop_list.things_to_save.average_sigmas.filename= {'average_zscore_sigmas.mat'};
parameters.loop_list.things_to_save.average_sigmas.variable= {'average_zscore_sigmas'}; 
parameters.loop_list.things_to_save.average_sigmas.level = 'comparison';

if parameters.removeOutliers
parameters.loop_list.things_to_save.sigma_outliers.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 continuous\'], 'comparison','\'};
parameters.loop_list.things_to_save.sigma_outliers.filename= {'outliers_zscore_sigmas.mat'};
parameters.loop_list.things_to_save.sigma_outliers.variable= {'outliers_zscore_sigmas'}; 
parameters.loop_list.things_to_save.sigma_outliers.level = 'comparison';
end
...
% Output
parameters.loop_list.things_to_save.Covs_bootstrap.dir = {[parameters.dir_exper 'PLSR\results\level 1 continuous\'], 'comparison', '\' 'mouse', '\'};
...
parameters.loop_list.things_to_load.dataset.level = 'comparison';
% optimized number of components to use.
parameters.loop_list.things_to_load.ncomponents_max.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison','\', 'mouse', '\'};
parameters.loop_list.things_to_load.ncomponents_max.filename= {'PLSR_results.mat'};
parameters.loop_list.things_to_load.ncomponents_max.variable= {'PLSR_results.ncomponents_used'};
parameters.loop_list.things_to_load.ncomponents_max.level = 'comparison';

% Output
parameters.loop_list.things_to_save.Covs_bootstrap.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
parameters.loop_list.things_to_save.Covs_bootstrap.filename= {'PLSR_Covs_bootstrap.mat'};
parameters.loop_list.things_to_save.Covs_bootstrap.variable= {'Covs_bootstrap'};
parameters.loop_list.things_to_save.Covs_bootstrap.level = 'comparison';
...
parameters.loop_list.things_to_load.average_sigmas.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 '], 'comparison_type', '\', 'comparison', '\'};
parameters.loop_list.things_to_load.average_sigmas.filename= {'average_zscore_sigmas.mat'};
parameters.loop_list.things_to_load.average_sigmas.variable= {'average_zscore_sigmas'}; 
parameters.loop_list.things_to_load.average_sigmas.level = 'comparison';
end
...
for typei = 1 %:numel(comparison_types)
    ...
    parameters.loop_list.iterators = {
                   ...
                   'mouse', {'loop_variables.mice_all(:).name'}, 'mouse_iterator'};
    % Input
    parameters.loop_list.things_to_load.data.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 2 ' parameters.comparison_type '\'], 'comparison', '\'};
    parameters.loop_list.things_to_load.data.filename = {'PLSR_dataset_info_Cov.mat'};
    parameters.loop_list.things_to_load.data.variable = {'dataset_info'};
    parameters.loop_list.things_to_load.data.level = 'comparison';

    parameters.loop_list.things_to_load.ncomponents_used.dir = {[parameters.dir_exper 'PLSR\results\level 1 categorical\'], 'comparison', '\' 'mouse', '\'};
    ...
    % Output
    parameters.loop_list.things_to_save.correlation.dir = {[parameters.dir_exper 'PLSR\results\level 2 ' parameters.comparison_type '\']};
...
% Inputs
parameters.loop_list.things_to_load.XL.dir = {[parameters.dir_exper 'PLSR\results\level 1 '], 'comparison_type', '\', 'comparison', '\' 'mouse', '\'};
...
parameters.loop_list.things_to_load.YL.dir = {[parameters.dir_exper 'PLSR\results\level 1 '], 'comparison_type', '\', 'comparison', '\' 'mouse', '\'};
...
parameters.loop_list.things_to_load.X0.dir = {[parameters.dir_exper 'PLSR\variable prep\datasets\level 1 '], 'comparison_type', '\', 'comparison', '\' 'mouse', '\'};
...
% Outputs
parameters.loop_list.things_to_save.variance_perVar.dir = {[parameters.dir_exper 'PLSR\results\level 1 '], 'comparison_type', '\', 'comparison', '\' 'mouse', '\'};
...
parameters.loop_list.things_to_save.variance_allVars.dir = {[parameters.dir_exper 'PLSR\results\level 1 '], 'comparison_type', '\', 'comparison', '\' 'mouse', '\'};
...
% Inputs 
parameters.loop_list.things_to_load.data.dir = {[parameters.dir_exper 'PLSR\results\level 2 '], 'comparison_type', '\', 'comparison', '\'};
