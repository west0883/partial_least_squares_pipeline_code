...
% SIMPLS Basic SIMPLS.  Performs no error checking. Taken from source code
% of Matlab built-in function plsregress.
function [Xloadings,Yloadings,Xscores,Yscores,Weights] = SIMPLSFunction(X0,Y0,ncomp)
